...
main(void) {
  ...
  800552:	ab27a783          	lw	a5,-1358(a5) # 801000 <zero>
  800556:	4585                	li	a1,1
  800558:	02f5c5b3          	div	a1,a1,a5
                 : "=r"(result)
                 : "r"(1), "r"(zero));
    cprintf("value is %d.\n", result);
  80055c:	00000517          	auipc	a0,0x0
  800560:	37c50513          	addi	a0,a0,892 # 8008d8 <error_string+0xc8>
  800564:	2581                	sext.w	a1,a1
  800566:	b99ff0ef          	jal	ra,8000fe <cprintf>
    panic("FAIL: T.T\n");
  80056a:	00000617          	auipc	a2,0x0
  80056e:	37e60613          	addi	a2,a2,894 # 8008e8 <error_string+0xd8>
  800572:	45b5                	li	a1,13
  800574:	00000517          	auipc	a0,0x0
  800578:	38450513          	addi	a0,a0,900 # 8008f8 <error_string+0xe8>
  80057c:	aa5ff0ef          	jal	ra,800020 <__panic>
