...
ffffffffc0200050:	61450513          	addi	a0,a0,1556 # ffffffffc0201660 <etext+0x4>
void print_kerninfo(void) {
...
ffffffffc0200066:	61e50513          	addi	a0,a0,1566 # ffffffffc0201680 <etext+0x24>
ffffffffc020006a:	0e2000ef          	jal	ra,ffffffffc020014c <cprintf>
    cprintf("  etext  0x%016lx (virtual)\n", etext);
ffffffffc020006e:	00001597          	auipc	a1,0x1
ffffffffc0200072:	5ee58593          	addi	a1,a1,1518 # ffffffffc020165c <etext>
ffffffffc0200076:	00001517          	auipc	a0,0x1
ffffffffc020007a:	62a50513          	addi	a0,a0,1578 # ffffffffc02016a0 <etext+0x44>
...
ffffffffc020008e:	63650513          	addi	a0,a0,1590 # ffffffffc02016c0 <etext+0x64>
...
ffffffffc02000a2:	64250513          	addi	a0,a0,1602 # ffffffffc02016e0 <etext+0x84>
...
ffffffffc02000d0:	63450513          	addi	a0,a0,1588 # ffffffffc0201700 <etext+0xa4>
}
...
ffffffffc02000ee:	e406                	sd	ra,8(sp)
    memset(edata, 0, end - edata);
ffffffffc02000f0:	152010ef          	jal	ra,ffffffffc0201242 <memset>
    dtb_init();
...
ffffffffc0200100:	63450513          	addi	a0,a0,1588 # ffffffffc0201730 <etext+0xd4>
...
ffffffffc020013e:	c602                	sw	zero,12(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc0200140:	180010ef          	jal	ra,ffffffffc02012c0 <vprintfmt>
    return cnt;
}
...
ffffffffc0200174:	c202                	sw	zero,4(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc0200176:	14a010ef          	jal	ra,ffffffffc02012c0 <vprintfmt>
    cnt = vcprintf(fmt, ap);
    va_end(ap);
    return cnt;
}
...
ffffffffc02001f6:	55e50513          	addi	a0,a0,1374 # ffffffffc0201750 <etext+0xf4>
    va_start(ap, fmt);
...
ffffffffc020020c:	52050513          	addi	a0,a0,1312 # ffffffffc0201728 <etext+0xcc>
...
ffffffffc020021c:	55850513          	addi	a0,a0,1368 # ffffffffc0201770 <etext+0x114>
void dtb_init(void) {
...
ffffffffc020024a:	53a50513          	addi	a0,a0,1338 # ffffffffc0201780 <etext+0x124>
...
ffffffffc0200260:	53450513          	addi	a0,a0,1332 # ffffffffc0201790 <etext+0x134>
...
ffffffffc0200270:	53c50513          	addi	a0,a0,1340 # ffffffffc02017a8 <etext+0x14c>
    if (boot_dtb == 0) {
...
ffffffffc020032a:	4d290913          	addi	s2,s2,1234 # ffffffffc02017f8 <etext+0x19c>
...
ffffffffc0200338:	4bc48493          	addi	s1,s1,1212 # ffffffffc02017f0 <etext+0x194>
...
ffffffffc020038c:	4e850513          	addi	a0,a0,1256 # ffffffffc0201870 <etext+0x214>
ffffffffc0200390:	dbdff0ef          	jal	ra,ffffffffc020014c <cprintf>
    }
    cprintf("DTB init completed\n");
ffffffffc0200394:	00001517          	auipc	a0,0x1
ffffffffc0200398:	51450513          	addi	a0,a0,1300 # ffffffffc02018a8 <etext+0x24c>
}
...
ffffffffc02003d8:	3f450513          	addi	a0,a0,1012 # ffffffffc02017c8 <etext+0x16c>
}
...
ffffffffc02003e2:	5e7000ef          	jal	ra,ffffffffc02011c8 <strlen>
...
ffffffffc02003ee:	2a01                	sext.w	s4,s4
                if (strncmp(name, "memory", 6) == 0) {
ffffffffc02003f0:	62d000ef          	jal	ra,ffffffffc020121c <strncmp>
...
ffffffffc0200486:	579000ef          	jal	ra,ffffffffc02011fe <strcmp>
...
ffffffffc020049e:	36650513          	addi	a0,a0,870 # ffffffffc0201800 <etext+0x1a4>
           fdt32_to_cpu(x >> 32);
...
ffffffffc020056c:	2b850513          	addi	a0,a0,696 # ffffffffc0201820 <etext+0x1c4>
...
ffffffffc020057e:	2be50513          	addi	a0,a0,702 # ffffffffc0201838 <etext+0x1dc>
...
ffffffffc0200590:	2cc50513          	addi	a0,a0,716 # ffffffffc0201858 <etext+0x1fc>
ffffffffc0200594:	bb9ff0ef          	jal	ra,ffffffffc020014c <cprintf>
    cprintf("DTB init completed\n");
ffffffffc0200598:	00001517          	auipc	a0,0x1
ffffffffc020059c:	31050513          	addi	a0,a0,784 # ffffffffc02018a8 <etext+0x24c>
        memory_base = mem_base;
...
ffffffffc02005cc:	0760106f          	j	ffffffffc0201642 <sbi_console_putchar>
...
ffffffffc0200606:	2be50513          	addi	a0,a0,702 # ffffffffc02018c0 <etext+0x264>
    pmm_manager = &best_fit_pmm_manager;
...
ffffffffc020064a:	2c250513          	addi	a0,a0,706 # ffffffffc0201908 <etext+0x2ac>
...
ffffffffc0200662:	2c250513          	addi	a0,a0,706 # ffffffffc0201920 <etext+0x2c4>
...
ffffffffc02006f0:	2bc50513          	addi	a0,a0,700 # ffffffffc02019a8 <etext+0x34c>
...
ffffffffc020072e:	29e50513          	addi	a0,a0,670 # ffffffffc02019c8 <etext+0x36c>
}
...
ffffffffc020076c:	21060613          	addi	a2,a2,528 # ffffffffc0201978 <etext+0x31c>
ffffffffc0200770:	06a00593          	li	a1,106
ffffffffc0200774:	00001517          	auipc	a0,0x1
ffffffffc0200778:	22450513          	addi	a0,a0,548 # ffffffffc0201998 <etext+0x33c>
ffffffffc020077c:	a47ff0ef          	jal	ra,ffffffffc02001c2 <__panic>
    uintptr_t freemem = PADDR((uintptr_t)pages + sizeof(struct Page) * (npage - nbase));
ffffffffc0200780:	00001617          	auipc	a2,0x1
ffffffffc0200784:	1d060613          	addi	a2,a2,464 # ffffffffc0201950 <etext+0x2f4>
ffffffffc0200788:	05e00593          	li	a1,94
ffffffffc020078c:	00001517          	auipc	a0,0x1
ffffffffc0200790:	16c50513          	addi	a0,a0,364 # ffffffffc02018f8 <etext+0x29c>
ffffffffc0200794:	a2fff0ef          	jal	ra,ffffffffc02001c2 <__panic>
        panic("DTB memory info not available");
ffffffffc0200798:	00001617          	auipc	a2,0x1
ffffffffc020079c:	14060613          	addi	a2,a2,320 # ffffffffc02018d8 <etext+0x27c>
ffffffffc02007a0:	04600593          	li	a1,70
ffffffffc02007a4:	00001517          	auipc	a0,0x1
ffffffffc02007a8:	15450513          	addi	a0,a0,340 # ffffffffc02018f8 <etext+0x29c>
...
ffffffffc02007b6:	19e60613          	addi	a2,a2,414 # ffffffffc0201950 <etext+0x2f4>
ffffffffc02007ba:	07900593          	li	a1,121
ffffffffc02007be:	00001517          	auipc	a0,0x1
ffffffffc02007c2:	13a50513          	addi	a0,a0,314 # ffffffffc02018f8 <etext+0x29c>
...
ffffffffc0200886:	18668693          	addi	a3,a3,390 # ffffffffc0201a08 <etext+0x3ac>
ffffffffc020088a:	00001617          	auipc	a2,0x1
ffffffffc020088e:	18660613          	addi	a2,a2,390 # ffffffffc0201a10 <etext+0x3b4>
ffffffffc0200892:	06b00593          	li	a1,107
ffffffffc0200896:	00001517          	auipc	a0,0x1
ffffffffc020089a:	19250513          	addi	a0,a0,402 # ffffffffc0201a28 <etext+0x3cc>
best_fit_alloc_pages(size_t n) {
...
ffffffffc0200b42:	f0268693          	addi	a3,a3,-254 # ffffffffc0201a40 <etext+0x3e4>
ffffffffc0200b46:	00001617          	auipc	a2,0x1
ffffffffc0200b4a:	eca60613          	addi	a2,a2,-310 # ffffffffc0201a10 <etext+0x3b4>
ffffffffc0200b4e:	10f00593          	li	a1,271
ffffffffc0200b52:	00001517          	auipc	a0,0x1
ffffffffc0200b56:	ed650513          	addi	a0,a0,-298 # ffffffffc0201a28 <etext+0x3cc>
ffffffffc0200b5a:	e68ff0ef          	jal	ra,ffffffffc02001c2 <__panic>
    assert(p0 != p1 && p0 != p2 && p1 != p2);
ffffffffc0200b5e:	00001697          	auipc	a3,0x1
ffffffffc0200b62:	f7268693          	addi	a3,a3,-142 # ffffffffc0201ad0 <etext+0x474>
ffffffffc0200b66:	00001617          	auipc	a2,0x1
ffffffffc0200b6a:	eaa60613          	addi	a2,a2,-342 # ffffffffc0201a10 <etext+0x3b4>
ffffffffc0200b6e:	0db00593          	li	a1,219
ffffffffc0200b72:	00001517          	auipc	a0,0x1
ffffffffc0200b76:	eb650513          	addi	a0,a0,-330 # ffffffffc0201a28 <etext+0x3cc>
ffffffffc0200b7a:	e48ff0ef          	jal	ra,ffffffffc02001c2 <__panic>
    assert(page_ref(p0) == 0 && page_ref(p1) == 0 && page_ref(p2) == 0);
ffffffffc0200b7e:	00001697          	auipc	a3,0x1
ffffffffc0200b82:	f7a68693          	addi	a3,a3,-134 # ffffffffc0201af8 <etext+0x49c>
ffffffffc0200b86:	00001617          	auipc	a2,0x1
ffffffffc0200b8a:	e8a60613          	addi	a2,a2,-374 # ffffffffc0201a10 <etext+0x3b4>
ffffffffc0200b8e:	0dc00593          	li	a1,220
ffffffffc0200b92:	00001517          	auipc	a0,0x1
ffffffffc0200b96:	e9650513          	addi	a0,a0,-362 # ffffffffc0201a28 <etext+0x3cc>
ffffffffc0200b9a:	e28ff0ef          	jal	ra,ffffffffc02001c2 <__panic>
    assert(page2pa(p0) < npage * PGSIZE);
ffffffffc0200b9e:	00001697          	auipc	a3,0x1
ffffffffc0200ba2:	f9a68693          	addi	a3,a3,-102 # ffffffffc0201b38 <etext+0x4dc>
ffffffffc0200ba6:	00001617          	auipc	a2,0x1
ffffffffc0200baa:	e6a60613          	addi	a2,a2,-406 # ffffffffc0201a10 <etext+0x3b4>
ffffffffc0200bae:	0de00593          	li	a1,222
ffffffffc0200bb2:	00001517          	auipc	a0,0x1
ffffffffc0200bb6:	e7650513          	addi	a0,a0,-394 # ffffffffc0201a28 <etext+0x3cc>
ffffffffc0200bba:	e08ff0ef          	jal	ra,ffffffffc02001c2 <__panic>
    assert(!list_empty(&free_list));
ffffffffc0200bbe:	00001697          	auipc	a3,0x1
ffffffffc0200bc2:	00268693          	addi	a3,a3,2 # ffffffffc0201bc0 <etext+0x564>
ffffffffc0200bc6:	00001617          	auipc	a2,0x1
ffffffffc0200bca:	e4a60613          	addi	a2,a2,-438 # ffffffffc0201a10 <etext+0x3b4>
ffffffffc0200bce:	0f700593          	li	a1,247
ffffffffc0200bd2:	00001517          	auipc	a0,0x1
ffffffffc0200bd6:	e5650513          	addi	a0,a0,-426 # ffffffffc0201a28 <etext+0x3cc>
ffffffffc0200bda:	de8ff0ef          	jal	ra,ffffffffc02001c2 <__panic>
    assert((p2 = alloc_page()) != NULL);
ffffffffc0200bde:	00001697          	auipc	a3,0x1
ffffffffc0200be2:	ed268693          	addi	a3,a3,-302 # ffffffffc0201ab0 <etext+0x454>
ffffffffc0200be6:	00001617          	auipc	a2,0x1
ffffffffc0200bea:	e2a60613          	addi	a2,a2,-470 # ffffffffc0201a10 <etext+0x3b4>
ffffffffc0200bee:	0d900593          	li	a1,217
ffffffffc0200bf2:	00001517          	auipc	a0,0x1
ffffffffc0200bf6:	e3650513          	addi	a0,a0,-458 # ffffffffc0201a28 <etext+0x3cc>
ffffffffc0200bfa:	dc8ff0ef          	jal	ra,ffffffffc02001c2 <__panic>
    assert(total == 0);
ffffffffc0200bfe:	00001697          	auipc	a3,0x1
ffffffffc0200c02:	0f268693          	addi	a3,a3,242 # ffffffffc0201cf0 <etext+0x694>
ffffffffc0200c06:	00001617          	auipc	a2,0x1
ffffffffc0200c0a:	e0a60613          	addi	a2,a2,-502 # ffffffffc0201a10 <etext+0x3b4>
ffffffffc0200c0e:	15100593          	li	a1,337
ffffffffc0200c12:	00001517          	auipc	a0,0x1
ffffffffc0200c16:	e1650513          	addi	a0,a0,-490 # ffffffffc0201a28 <etext+0x3cc>
ffffffffc0200c1a:	da8ff0ef          	jal	ra,ffffffffc02001c2 <__panic>
    assert(total == nr_free_pages());
ffffffffc0200c1e:	00001697          	auipc	a3,0x1
ffffffffc0200c22:	e3268693          	addi	a3,a3,-462 # ffffffffc0201a50 <etext+0x3f4>
ffffffffc0200c26:	00001617          	auipc	a2,0x1
ffffffffc0200c2a:	dea60613          	addi	a2,a2,-534 # ffffffffc0201a10 <etext+0x3b4>
ffffffffc0200c2e:	11200593          	li	a1,274
ffffffffc0200c32:	00001517          	auipc	a0,0x1
ffffffffc0200c36:	df650513          	addi	a0,a0,-522 # ffffffffc0201a28 <etext+0x3cc>
ffffffffc0200c3a:	d88ff0ef          	jal	ra,ffffffffc02001c2 <__panic>
    assert((p1 = alloc_page()) != NULL);
ffffffffc0200c3e:	00001697          	auipc	a3,0x1
ffffffffc0200c42:	e5268693          	addi	a3,a3,-430 # ffffffffc0201a90 <etext+0x434>
ffffffffc0200c46:	00001617          	auipc	a2,0x1
ffffffffc0200c4a:	dca60613          	addi	a2,a2,-566 # ffffffffc0201a10 <etext+0x3b4>
ffffffffc0200c4e:	0d800593          	li	a1,216
ffffffffc0200c52:	00001517          	auipc	a0,0x1
ffffffffc0200c56:	dd650513          	addi	a0,a0,-554 # ffffffffc0201a28 <etext+0x3cc>
ffffffffc0200c5a:	d68ff0ef          	jal	ra,ffffffffc02001c2 <__panic>
    assert((p0 = alloc_page()) != NULL);
ffffffffc0200c5e:	00001697          	auipc	a3,0x1
ffffffffc0200c62:	e1268693          	addi	a3,a3,-494 # ffffffffc0201a70 <etext+0x414>
ffffffffc0200c66:	00001617          	auipc	a2,0x1
ffffffffc0200c6a:	daa60613          	addi	a2,a2,-598 # ffffffffc0201a10 <etext+0x3b4>
ffffffffc0200c6e:	0d700593          	li	a1,215
ffffffffc0200c72:	00001517          	auipc	a0,0x1
ffffffffc0200c76:	db650513          	addi	a0,a0,-586 # ffffffffc0201a28 <etext+0x3cc>
ffffffffc0200c7a:	d48ff0ef          	jal	ra,ffffffffc02001c2 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0200c7e:	00001697          	auipc	a3,0x1
ffffffffc0200c82:	f1a68693          	addi	a3,a3,-230 # ffffffffc0201b98 <etext+0x53c>
ffffffffc0200c86:	00001617          	auipc	a2,0x1
ffffffffc0200c8a:	d8a60613          	addi	a2,a2,-630 # ffffffffc0201a10 <etext+0x3b4>
ffffffffc0200c8e:	0f400593          	li	a1,244
ffffffffc0200c92:	00001517          	auipc	a0,0x1
ffffffffc0200c96:	d9650513          	addi	a0,a0,-618 # ffffffffc0201a28 <etext+0x3cc>
ffffffffc0200c9a:	d28ff0ef          	jal	ra,ffffffffc02001c2 <__panic>
    assert((p2 = alloc_page()) != NULL);
ffffffffc0200c9e:	00001697          	auipc	a3,0x1
ffffffffc0200ca2:	e1268693          	addi	a3,a3,-494 # ffffffffc0201ab0 <etext+0x454>
ffffffffc0200ca6:	00001617          	auipc	a2,0x1
ffffffffc0200caa:	d6a60613          	addi	a2,a2,-662 # ffffffffc0201a10 <etext+0x3b4>
ffffffffc0200cae:	0f200593          	li	a1,242
ffffffffc0200cb2:	00001517          	auipc	a0,0x1
ffffffffc0200cb6:	d7650513          	addi	a0,a0,-650 # ffffffffc0201a28 <etext+0x3cc>
ffffffffc0200cba:	d08ff0ef          	jal	ra,ffffffffc02001c2 <__panic>
    assert((p1 = alloc_page()) != NULL);
ffffffffc0200cbe:	00001697          	auipc	a3,0x1
ffffffffc0200cc2:	dd268693          	addi	a3,a3,-558 # ffffffffc0201a90 <etext+0x434>
ffffffffc0200cc6:	00001617          	auipc	a2,0x1
ffffffffc0200cca:	d4a60613          	addi	a2,a2,-694 # ffffffffc0201a10 <etext+0x3b4>
ffffffffc0200cce:	0f100593          	li	a1,241
ffffffffc0200cd2:	00001517          	auipc	a0,0x1
ffffffffc0200cd6:	d5650513          	addi	a0,a0,-682 # ffffffffc0201a28 <etext+0x3cc>
ffffffffc0200cda:	ce8ff0ef          	jal	ra,ffffffffc02001c2 <__panic>
    assert((p0 = alloc_page()) != NULL);
ffffffffc0200cde:	00001697          	auipc	a3,0x1
ffffffffc0200ce2:	d9268693          	addi	a3,a3,-622 # ffffffffc0201a70 <etext+0x414>
ffffffffc0200ce6:	00001617          	auipc	a2,0x1
ffffffffc0200cea:	d2a60613          	addi	a2,a2,-726 # ffffffffc0201a10 <etext+0x3b4>
ffffffffc0200cee:	0f000593          	li	a1,240
ffffffffc0200cf2:	00001517          	auipc	a0,0x1
ffffffffc0200cf6:	d3650513          	addi	a0,a0,-714 # ffffffffc0201a28 <etext+0x3cc>
ffffffffc0200cfa:	cc8ff0ef          	jal	ra,ffffffffc02001c2 <__panic>
    assert(nr_free == 3);
ffffffffc0200cfe:	00001697          	auipc	a3,0x1
ffffffffc0200d02:	eb268693          	addi	a3,a3,-334 # ffffffffc0201bb0 <etext+0x554>
ffffffffc0200d06:	00001617          	auipc	a2,0x1
ffffffffc0200d0a:	d0a60613          	addi	a2,a2,-758 # ffffffffc0201a10 <etext+0x3b4>
ffffffffc0200d0e:	0ee00593          	li	a1,238
ffffffffc0200d12:	00001517          	auipc	a0,0x1
ffffffffc0200d16:	d1650513          	addi	a0,a0,-746 # ffffffffc0201a28 <etext+0x3cc>
ffffffffc0200d1a:	ca8ff0ef          	jal	ra,ffffffffc02001c2 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0200d1e:	00001697          	auipc	a3,0x1
ffffffffc0200d22:	e7a68693          	addi	a3,a3,-390 # ffffffffc0201b98 <etext+0x53c>
ffffffffc0200d26:	00001617          	auipc	a2,0x1
ffffffffc0200d2a:	cea60613          	addi	a2,a2,-790 # ffffffffc0201a10 <etext+0x3b4>
ffffffffc0200d2e:	0e900593          	li	a1,233
ffffffffc0200d32:	00001517          	auipc	a0,0x1
ffffffffc0200d36:	cf650513          	addi	a0,a0,-778 # ffffffffc0201a28 <etext+0x3cc>
ffffffffc0200d3a:	c88ff0ef          	jal	ra,ffffffffc02001c2 <__panic>
    assert(page2pa(p2) < npage * PGSIZE);
ffffffffc0200d3e:	00001697          	auipc	a3,0x1
ffffffffc0200d42:	e3a68693          	addi	a3,a3,-454 # ffffffffc0201b78 <etext+0x51c>
ffffffffc0200d46:	00001617          	auipc	a2,0x1
ffffffffc0200d4a:	cca60613          	addi	a2,a2,-822 # ffffffffc0201a10 <etext+0x3b4>
ffffffffc0200d4e:	0e000593          	li	a1,224
ffffffffc0200d52:	00001517          	auipc	a0,0x1
ffffffffc0200d56:	cd650513          	addi	a0,a0,-810 # ffffffffc0201a28 <etext+0x3cc>
ffffffffc0200d5a:	c68ff0ef          	jal	ra,ffffffffc02001c2 <__panic>
    assert(page2pa(p1) < npage * PGSIZE);
ffffffffc0200d5e:	00001697          	auipc	a3,0x1
ffffffffc0200d62:	dfa68693          	addi	a3,a3,-518 # ffffffffc0201b58 <etext+0x4fc>
ffffffffc0200d66:	00001617          	auipc	a2,0x1
ffffffffc0200d6a:	caa60613          	addi	a2,a2,-854 # ffffffffc0201a10 <etext+0x3b4>
ffffffffc0200d6e:	0df00593          	li	a1,223
ffffffffc0200d72:	00001517          	auipc	a0,0x1
ffffffffc0200d76:	cb650513          	addi	a0,a0,-842 # ffffffffc0201a28 <etext+0x3cc>
ffffffffc0200d7a:	c48ff0ef          	jal	ra,ffffffffc02001c2 <__panic>
    assert(count == 0);
ffffffffc0200d7e:	00001697          	auipc	a3,0x1
ffffffffc0200d82:	f6268693          	addi	a3,a3,-158 # ffffffffc0201ce0 <etext+0x684>
ffffffffc0200d86:	00001617          	auipc	a2,0x1
ffffffffc0200d8a:	c8a60613          	addi	a2,a2,-886 # ffffffffc0201a10 <etext+0x3b4>
ffffffffc0200d8e:	15000593          	li	a1,336
ffffffffc0200d92:	00001517          	auipc	a0,0x1
ffffffffc0200d96:	c9650513          	addi	a0,a0,-874 # ffffffffc0201a28 <etext+0x3cc>
ffffffffc0200d9a:	c28ff0ef          	jal	ra,ffffffffc02001c2 <__panic>
    assert(nr_free == 0);
ffffffffc0200d9e:	00001697          	auipc	a3,0x1
ffffffffc0200da2:	e5a68693          	addi	a3,a3,-422 # ffffffffc0201bf8 <etext+0x59c>
ffffffffc0200da6:	00001617          	auipc	a2,0x1
ffffffffc0200daa:	c6a60613          	addi	a2,a2,-918 # ffffffffc0201a10 <etext+0x3b4>
ffffffffc0200dae:	14500593          	li	a1,325
ffffffffc0200db2:	00001517          	auipc	a0,0x1
ffffffffc0200db6:	c7650513          	addi	a0,a0,-906 # ffffffffc0201a28 <etext+0x3cc>
ffffffffc0200dba:	c08ff0ef          	jal	ra,ffffffffc02001c2 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0200dbe:	00001697          	auipc	a3,0x1
ffffffffc0200dc2:	dda68693          	addi	a3,a3,-550 # ffffffffc0201b98 <etext+0x53c>
ffffffffc0200dc6:	00001617          	auipc	a2,0x1
ffffffffc0200dca:	c4a60613          	addi	a2,a2,-950 # ffffffffc0201a10 <etext+0x3b4>
ffffffffc0200dce:	13f00593          	li	a1,319
ffffffffc0200dd2:	00001517          	auipc	a0,0x1
ffffffffc0200dd6:	c5650513          	addi	a0,a0,-938 # ffffffffc0201a28 <etext+0x3cc>
ffffffffc0200dda:	be8ff0ef          	jal	ra,ffffffffc02001c2 <__panic>
    assert((p0 = alloc_pages(5)) != NULL);
ffffffffc0200dde:	00001697          	auipc	a3,0x1
ffffffffc0200de2:	ee268693          	addi	a3,a3,-286 # ffffffffc0201cc0 <etext+0x664>
ffffffffc0200de6:	00001617          	auipc	a2,0x1
ffffffffc0200dea:	c2a60613          	addi	a2,a2,-982 # ffffffffc0201a10 <etext+0x3b4>
ffffffffc0200dee:	13e00593          	li	a1,318
ffffffffc0200df2:	00001517          	auipc	a0,0x1
ffffffffc0200df6:	c3650513          	addi	a0,a0,-970 # ffffffffc0201a28 <etext+0x3cc>
ffffffffc0200dfa:	bc8ff0ef          	jal	ra,ffffffffc02001c2 <__panic>
    assert(p0 + 4 == p1);
ffffffffc0200dfe:	00001697          	auipc	a3,0x1
ffffffffc0200e02:	eb268693          	addi	a3,a3,-334 # ffffffffc0201cb0 <etext+0x654>
ffffffffc0200e06:	00001617          	auipc	a2,0x1
ffffffffc0200e0a:	c0a60613          	addi	a2,a2,-1014 # ffffffffc0201a10 <etext+0x3b4>
ffffffffc0200e0e:	13600593          	li	a1,310
ffffffffc0200e12:	00001517          	auipc	a0,0x1
ffffffffc0200e16:	c1650513          	addi	a0,a0,-1002 # ffffffffc0201a28 <etext+0x3cc>
ffffffffc0200e1a:	ba8ff0ef          	jal	ra,ffffffffc02001c2 <__panic>
    assert(alloc_pages(2) != NULL);      // best fit feature
ffffffffc0200e1e:	00001697          	auipc	a3,0x1
ffffffffc0200e22:	e7a68693          	addi	a3,a3,-390 # ffffffffc0201c98 <etext+0x63c>
ffffffffc0200e26:	00001617          	auipc	a2,0x1
ffffffffc0200e2a:	bea60613          	addi	a2,a2,-1046 # ffffffffc0201a10 <etext+0x3b4>
ffffffffc0200e2e:	13500593          	li	a1,309
ffffffffc0200e32:	00001517          	auipc	a0,0x1
ffffffffc0200e36:	bf650513          	addi	a0,a0,-1034 # ffffffffc0201a28 <etext+0x3cc>
ffffffffc0200e3a:	b88ff0ef          	jal	ra,ffffffffc02001c2 <__panic>
    assert((p1 = alloc_pages(1)) != NULL);
ffffffffc0200e3e:	00001697          	auipc	a3,0x1
ffffffffc0200e42:	e3a68693          	addi	a3,a3,-454 # ffffffffc0201c78 <etext+0x61c>
ffffffffc0200e46:	00001617          	auipc	a2,0x1
ffffffffc0200e4a:	bca60613          	addi	a2,a2,-1078 # ffffffffc0201a10 <etext+0x3b4>
ffffffffc0200e4e:	13400593          	li	a1,308
ffffffffc0200e52:	00001517          	auipc	a0,0x1
ffffffffc0200e56:	bd650513          	addi	a0,a0,-1066 # ffffffffc0201a28 <etext+0x3cc>
ffffffffc0200e5a:	b68ff0ef          	jal	ra,ffffffffc02001c2 <__panic>
    assert(PageProperty(p0 + 1) && p0[1].property == 2);
ffffffffc0200e5e:	00001697          	auipc	a3,0x1
ffffffffc0200e62:	dea68693          	addi	a3,a3,-534 # ffffffffc0201c48 <etext+0x5ec>
ffffffffc0200e66:	00001617          	auipc	a2,0x1
ffffffffc0200e6a:	baa60613          	addi	a2,a2,-1110 # ffffffffc0201a10 <etext+0x3b4>
ffffffffc0200e6e:	13200593          	li	a1,306
ffffffffc0200e72:	00001517          	auipc	a0,0x1
ffffffffc0200e76:	bb650513          	addi	a0,a0,-1098 # ffffffffc0201a28 <etext+0x3cc>
ffffffffc0200e7a:	b48ff0ef          	jal	ra,ffffffffc02001c2 <__panic>
    assert(alloc_pages(4) == NULL);
ffffffffc0200e7e:	00001697          	auipc	a3,0x1
ffffffffc0200e82:	db268693          	addi	a3,a3,-590 # ffffffffc0201c30 <etext+0x5d4>
ffffffffc0200e86:	00001617          	auipc	a2,0x1
ffffffffc0200e8a:	b8a60613          	addi	a2,a2,-1142 # ffffffffc0201a10 <etext+0x3b4>
ffffffffc0200e8e:	13100593          	li	a1,305
ffffffffc0200e92:	00001517          	auipc	a0,0x1
ffffffffc0200e96:	b9650513          	addi	a0,a0,-1130 # ffffffffc0201a28 <etext+0x3cc>
ffffffffc0200e9a:	b28ff0ef          	jal	ra,ffffffffc02001c2 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0200e9e:	00001697          	auipc	a3,0x1
ffffffffc0200ea2:	cfa68693          	addi	a3,a3,-774 # ffffffffc0201b98 <etext+0x53c>
ffffffffc0200ea6:	00001617          	auipc	a2,0x1
ffffffffc0200eaa:	b6a60613          	addi	a2,a2,-1174 # ffffffffc0201a10 <etext+0x3b4>
ffffffffc0200eae:	12500593          	li	a1,293
ffffffffc0200eb2:	00001517          	auipc	a0,0x1
ffffffffc0200eb6:	b7650513          	addi	a0,a0,-1162 # ffffffffc0201a28 <etext+0x3cc>
ffffffffc0200eba:	b08ff0ef          	jal	ra,ffffffffc02001c2 <__panic>
    assert(!PageProperty(p0));
ffffffffc0200ebe:	00001697          	auipc	a3,0x1
ffffffffc0200ec2:	d5a68693          	addi	a3,a3,-678 # ffffffffc0201c18 <etext+0x5bc>
ffffffffc0200ec6:	00001617          	auipc	a2,0x1
ffffffffc0200eca:	b4a60613          	addi	a2,a2,-1206 # ffffffffc0201a10 <etext+0x3b4>
ffffffffc0200ece:	11c00593          	li	a1,284
ffffffffc0200ed2:	00001517          	auipc	a0,0x1
ffffffffc0200ed6:	b5650513          	addi	a0,a0,-1194 # ffffffffc0201a28 <etext+0x3cc>
ffffffffc0200eda:	ae8ff0ef          	jal	ra,ffffffffc02001c2 <__panic>
    assert(p0 != NULL);
ffffffffc0200ede:	00001697          	auipc	a3,0x1
ffffffffc0200ee2:	d2a68693          	addi	a3,a3,-726 # ffffffffc0201c08 <etext+0x5ac>
ffffffffc0200ee6:	00001617          	auipc	a2,0x1
ffffffffc0200eea:	b2a60613          	addi	a2,a2,-1238 # ffffffffc0201a10 <etext+0x3b4>
ffffffffc0200eee:	11b00593          	li	a1,283
ffffffffc0200ef2:	00001517          	auipc	a0,0x1
ffffffffc0200ef6:	b3650513          	addi	a0,a0,-1226 # ffffffffc0201a28 <etext+0x3cc>
ffffffffc0200efa:	ac8ff0ef          	jal	ra,ffffffffc02001c2 <__panic>
    assert(nr_free == 0);
ffffffffc0200efe:	00001697          	auipc	a3,0x1
ffffffffc0200f02:	cfa68693          	addi	a3,a3,-774 # ffffffffc0201bf8 <etext+0x59c>
ffffffffc0200f06:	00001617          	auipc	a2,0x1
ffffffffc0200f0a:	b0a60613          	addi	a2,a2,-1270 # ffffffffc0201a10 <etext+0x3b4>
ffffffffc0200f0e:	0fd00593          	li	a1,253
ffffffffc0200f12:	00001517          	auipc	a0,0x1
ffffffffc0200f16:	b1650513          	addi	a0,a0,-1258 # ffffffffc0201a28 <etext+0x3cc>
ffffffffc0200f1a:	aa8ff0ef          	jal	ra,ffffffffc02001c2 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0200f1e:	00001697          	auipc	a3,0x1
ffffffffc0200f22:	c7a68693          	addi	a3,a3,-902 # ffffffffc0201b98 <etext+0x53c>
ffffffffc0200f26:	00001617          	auipc	a2,0x1
ffffffffc0200f2a:	aea60613          	addi	a2,a2,-1302 # ffffffffc0201a10 <etext+0x3b4>
ffffffffc0200f2e:	0fb00593          	li	a1,251
ffffffffc0200f32:	00001517          	auipc	a0,0x1
ffffffffc0200f36:	af650513          	addi	a0,a0,-1290 # ffffffffc0201a28 <etext+0x3cc>
ffffffffc0200f3a:	a88ff0ef          	jal	ra,ffffffffc02001c2 <__panic>
    assert((p = alloc_page()) == p0);
ffffffffc0200f3e:	00001697          	auipc	a3,0x1
ffffffffc0200f42:	c9a68693          	addi	a3,a3,-870 # ffffffffc0201bd8 <etext+0x57c>
ffffffffc0200f46:	00001617          	auipc	a2,0x1
ffffffffc0200f4a:	aca60613          	addi	a2,a2,-1334 # ffffffffc0201a10 <etext+0x3b4>
ffffffffc0200f4e:	0fa00593          	li	a1,250
ffffffffc0200f52:	00001517          	auipc	a0,0x1
ffffffffc0200f56:	ad650513          	addi	a0,a0,-1322 # ffffffffc0201a28 <etext+0x3cc>
...
ffffffffc020109e:	c6668693          	addi	a3,a3,-922 # ffffffffc0201d00 <etext+0x6a4>
ffffffffc02010a2:	00001617          	auipc	a2,0x1
ffffffffc02010a6:	96e60613          	addi	a2,a2,-1682 # ffffffffc0201a10 <etext+0x3b4>
ffffffffc02010aa:	09500593          	li	a1,149
ffffffffc02010ae:	00001517          	auipc	a0,0x1
ffffffffc02010b2:	97a50513          	addi	a0,a0,-1670 # ffffffffc0201a28 <etext+0x3cc>
ffffffffc02010b6:	90cff0ef          	jal	ra,ffffffffc02001c2 <__panic>
    assert(n > 0);
ffffffffc02010ba:	00001697          	auipc	a3,0x1
ffffffffc02010be:	94e68693          	addi	a3,a3,-1714 # ffffffffc0201a08 <etext+0x3ac>
ffffffffc02010c2:	00001617          	auipc	a2,0x1
ffffffffc02010c6:	94e60613          	addi	a2,a2,-1714 # ffffffffc0201a10 <etext+0x3b4>
ffffffffc02010ca:	09200593          	li	a1,146
ffffffffc02010ce:	00001517          	auipc	a0,0x1
ffffffffc02010d2:	95a50513          	addi	a0,a0,-1702 # ffffffffc0201a28 <etext+0x3cc>
...
ffffffffc02010dc:	e406                	sd	ra,8(sp)
    assert(n > 0);
ffffffffc02010de:	c5e9                	beqz	a1,ffffffffc02011a8 <best_fit_init_memmap+0xce>
    for (; p != base + n; p ++) {
...
ffffffffc02010ec:	00d50d63          	beq	a0,a3,ffffffffc0201106 <best_fit_init_memmap+0x2c>
        assert(PageReserved(p));
ffffffffc02010f0:	6798                	ld	a4,8(a5)
ffffffffc02010f2:	8b05                	andi	a4,a4,1
ffffffffc02010f4:	cb51                	beqz	a4,ffffffffc0201188 <best_fit_init_memmap+0xae>
        p->flags = 0;
ffffffffc02010f6:	0007b423          	sd	zero,8(a5)
ffffffffc02010fa:	0007a023          	sw	zero,0(a5)
    for (; p != base + n; p ++) {
ffffffffc02010fe:	02878793          	addi	a5,a5,40
ffffffffc0201102:	fed797e3          	bne	a5,a3,ffffffffc02010f0 <best_fit_init_memmap+0x16>
    SetPageProperty(base);
ffffffffc0201106:	6510                	ld	a2,8(a0)
    nr_free += n;
ffffffffc0201108:	00004697          	auipc	a3,0x4
ffffffffc020110c:	f1068693          	addi	a3,a3,-240 # ffffffffc0205018 <free_area>
ffffffffc0201110:	4a98                	lw	a4,16(a3)
    base->property = n;
ffffffffc0201112:	2581                	sext.w	a1,a1
    SetPageProperty(base);
ffffffffc0201114:	00266613          	ori	a2,a2,2
    return list->next == list;
ffffffffc0201118:	669c                	ld	a5,8(a3)
    base->property = n;
ffffffffc020111a:	c90c                	sw	a1,16(a0)
    SetPageProperty(base);
ffffffffc020111c:	e510                	sd	a2,8(a0)
    nr_free += n;
ffffffffc020111e:	9db9                	addw	a1,a1,a4
ffffffffc0201120:	ca8c                	sw	a1,16(a3)
        list_add(&free_list, &(base->page_link));
ffffffffc0201122:	01850613          	addi	a2,a0,24
    if (list_empty(&free_list)) {
ffffffffc0201126:	04d78a63          	beq	a5,a3,ffffffffc020117a <best_fit_init_memmap+0xa0>
            struct Page* page = le2page(le, page_link);
ffffffffc020112a:	fe878713          	addi	a4,a5,-24
ffffffffc020112e:	0006b803          	ld	a6,0(a3)
    if (list_empty(&free_list)) {
ffffffffc0201132:	4581                	li	a1,0
            if(base<page){
ffffffffc0201134:	00e56a63          	bltu	a0,a4,ffffffffc0201148 <best_fit_init_memmap+0x6e>
    return listelm->next;
ffffffffc0201138:	6798                	ld	a4,8(a5)
            }else if(list_next(le) == &free_list){
ffffffffc020113a:	02d70263          	beq	a4,a3,ffffffffc020115e <best_fit_init_memmap+0x84>
    for (; p != base + n; p ++) {
ffffffffc020113e:	87ba                	mv	a5,a4
            struct Page* page = le2page(le, page_link);
ffffffffc0201140:	fe878713          	addi	a4,a5,-24
            if(base<page){
ffffffffc0201144:	fee57ae3          	bgeu	a0,a4,ffffffffc0201138 <best_fit_init_memmap+0x5e>
ffffffffc0201148:	c199                	beqz	a1,ffffffffc020114e <best_fit_init_memmap+0x74>
ffffffffc020114a:	0106b023          	sd	a6,0(a3)
    __list_add(elm, listelm->prev, listelm);
ffffffffc020114e:	6398                	ld	a4,0(a5)
}
ffffffffc0201150:	60a2                	ld	ra,8(sp)
    prev->next = next->prev = elm;
ffffffffc0201152:	e390                	sd	a2,0(a5)
ffffffffc0201154:	e710                	sd	a2,8(a4)
    elm->next = next;
...
ffffffffc020115c:	8082                	ret
    prev->next = next->prev = elm;
ffffffffc020115e:	e790                	sd	a2,8(a5)
    elm->next = next;
ffffffffc0201160:	f114                	sd	a3,32(a0)
    return listelm->next;
ffffffffc0201162:	6798                	ld	a4,8(a5)
    elm->prev = prev;
ffffffffc0201164:	ed1c                	sd	a5,24(a0)
        while ((le = list_next(le)) != &free_list) {
ffffffffc0201166:	00d70663          	beq	a4,a3,ffffffffc0201172 <best_fit_init_memmap+0x98>
    prev->next = next->prev = elm;
ffffffffc020116a:	8832                	mv	a6,a2
ffffffffc020116c:	4585                	li	a1,1
    for (; p != base + n; p ++) {
ffffffffc020116e:	87ba                	mv	a5,a4
ffffffffc0201170:	bfc1                	j	ffffffffc0201140 <best_fit_init_memmap+0x66>
}
ffffffffc0201172:	60a2                	ld	ra,8(sp)
ffffffffc0201174:	e290                	sd	a2,0(a3)
ffffffffc0201176:	0141                	addi	sp,sp,16
ffffffffc0201178:	8082                	ret
ffffffffc020117a:	60a2                	ld	ra,8(sp)
ffffffffc020117c:	e390                	sd	a2,0(a5)
ffffffffc020117e:	e790                	sd	a2,8(a5)
    elm->next = next;
ffffffffc0201180:	f11c                	sd	a5,32(a0)
    elm->prev = prev;
ffffffffc0201182:	ed1c                	sd	a5,24(a0)
ffffffffc0201184:	0141                	addi	sp,sp,16
ffffffffc0201186:	8082                	ret
        assert(PageReserved(p));
ffffffffc0201188:	00001697          	auipc	a3,0x1
ffffffffc020118c:	ba068693          	addi	a3,a3,-1120 # ffffffffc0201d28 <etext+0x6cc>
ffffffffc0201190:	00001617          	auipc	a2,0x1
ffffffffc0201194:	88060613          	addi	a2,a2,-1920 # ffffffffc0201a10 <etext+0x3b4>
ffffffffc0201198:	04a00593          	li	a1,74
ffffffffc020119c:	00001517          	auipc	a0,0x1
ffffffffc02011a0:	88c50513          	addi	a0,a0,-1908 # ffffffffc0201a28 <etext+0x3cc>
ffffffffc02011a4:	81eff0ef          	jal	ra,ffffffffc02001c2 <__panic>
    assert(n > 0);
ffffffffc02011a8:	00001697          	auipc	a3,0x1
ffffffffc02011ac:	86068693          	addi	a3,a3,-1952 # ffffffffc0201a08 <etext+0x3ac>
ffffffffc02011b0:	00001617          	auipc	a2,0x1
ffffffffc02011b4:	86060613          	addi	a2,a2,-1952 # ffffffffc0201a10 <etext+0x3b4>
ffffffffc02011b8:	04700593          	li	a1,71
ffffffffc02011bc:	00001517          	auipc	a0,0x1
ffffffffc02011c0:	86c50513          	addi	a0,a0,-1940 # ffffffffc0201a28 <etext+0x3cc>
ffffffffc02011c4:	ffffe0ef          	jal	ra,ffffffffc02001c2 <__panic>

ffffffffc02011c8 <strlen>:
...
strlen(const char *s) {
    size_t cnt = 0;
    while (*s ++ != '\0') {
ffffffffc02011c8:	00054783          	lbu	a5,0(a0)
strlen(const char *s) {
ffffffffc02011cc:	872a                	mv	a4,a0
    size_t cnt = 0;
ffffffffc02011ce:	4501                	li	a0,0
    while (*s ++ != '\0') {
ffffffffc02011d0:	cb81                	beqz	a5,ffffffffc02011e0 <strlen+0x18>
        cnt ++;
ffffffffc02011d2:	0505                	addi	a0,a0,1
    while (*s ++ != '\0') {
ffffffffc02011d4:	00a707b3          	add	a5,a4,a0
ffffffffc02011d8:	0007c783          	lbu	a5,0(a5)
ffffffffc02011dc:	fbfd                	bnez	a5,ffffffffc02011d2 <strlen+0xa>
...
ffffffffc02011f2:	00074703          	lbu	a4,0(a4) # fffffffffff80000 <end+0x3fd7af88>
...
ffffffffc0201202:	0005c703          	lbu	a4,0(a1)
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0201206:	cb89                	beqz	a5,ffffffffc0201218 <strcmp+0x1a>
        s1 ++, s2 ++;
ffffffffc0201208:	0505                	addi	a0,a0,1
ffffffffc020120a:	0585                	addi	a1,a1,1
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc020120c:	fee789e3          	beq	a5,a4,ffffffffc02011fe <strcmp>
    return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc0201210:	0007851b          	sext.w	a0,a5
#endif /* __HAVE_ARCH_STRCMP */
}
ffffffffc0201214:	9d19                	subw	a0,a0,a4
ffffffffc0201216:	8082                	ret
ffffffffc0201218:	4501                	li	a0,0
ffffffffc020121a:	bfed                	j	ffffffffc0201214 <strcmp+0x16>

ffffffffc020121c <strncmp>:
...
ffffffffc020121c:	c20d                	beqz	a2,ffffffffc020123e <strncmp+0x22>
ffffffffc020121e:	962e                	add	a2,a2,a1
ffffffffc0201220:	a031                	j	ffffffffc020122c <strncmp+0x10>
        n --, s1 ++, s2 ++;
ffffffffc0201222:	0505                	addi	a0,a0,1
    while (n > 0 && *s1 != '\0' && *s1 == *s2) {
ffffffffc0201224:	00e79a63          	bne	a5,a4,ffffffffc0201238 <strncmp+0x1c>
ffffffffc0201228:	00b60b63          	beq	a2,a1,ffffffffc020123e <strncmp+0x22>
ffffffffc020122c:	00054783          	lbu	a5,0(a0)
        n --, s1 ++, s2 ++;
ffffffffc0201230:	0585                	addi	a1,a1,1
    while (n > 0 && *s1 != '\0' && *s1 == *s2) {
ffffffffc0201232:	fff5c703          	lbu	a4,-1(a1)
ffffffffc0201236:	f7f5                	bnez	a5,ffffffffc0201222 <strncmp+0x6>
    }
    return (n == 0) ? 0 : (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc0201238:	40e7853b          	subw	a0,a5,a4
}
...
memset(void *s, char c, size_t n) {
    ...
    char *p = s;
    while (n -- > 0) {
ffffffffc0201242:	ca01                	beqz	a2,ffffffffc0201252 <memset+0x10>
ffffffffc0201244:	962a                	add	a2,a2,a0
    char *p = s;
ffffffffc0201246:	87aa                	mv	a5,a0
        *p ++ = c;
ffffffffc0201248:	0785                	addi	a5,a5,1
ffffffffc020124a:	feb78fa3          	sb	a1,-1(a5)
    while (n -- > 0) {
ffffffffc020124e:	fec79de3          	bne	a5,a2,ffffffffc0201248 <memset+0x6>
    }
    return s;
...
ffffffffc0201254:	02069813          	slli	a6,a3,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0201258:	7179                	addi	sp,sp,-48
    unsigned mod = do_div(result, base);
ffffffffc020125a:	02085813          	srli	a6,a6,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc020125e:	e052                	sd	s4,0(sp)
    unsigned mod = do_div(result, base);
ffffffffc0201260:	03067a33          	remu	s4,a2,a6
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0201264:	f022                	sd	s0,32(sp)
ffffffffc0201266:	ec26                	sd	s1,24(sp)
ffffffffc0201268:	e84a                	sd	s2,16(sp)
ffffffffc020126a:	f406                	sd	ra,40(sp)
ffffffffc020126c:	e44e                	sd	s3,8(sp)
ffffffffc020126e:	84aa                	mv	s1,a0
ffffffffc0201270:	892e                	mv	s2,a1
    ...
    if (num >= base) {
        ...
        while (-- width > 0)
ffffffffc0201272:	fff7041b          	addiw	s0,a4,-1
    unsigned mod = do_div(result, base);
ffffffffc0201276:	2a01                	sext.w	s4,s4
    if (num >= base) {
ffffffffc0201278:	03067e63          	bgeu	a2,a6,ffffffffc02012b4 <printnum+0x60>
ffffffffc020127c:	89be                	mv	s3,a5
        while (-- width > 0)
ffffffffc020127e:	00805763          	blez	s0,ffffffffc020128c <printnum+0x38>
ffffffffc0201282:	347d                	addiw	s0,s0,-1
            putch(padc, putdat);
ffffffffc0201284:	85ca                	mv	a1,s2
ffffffffc0201286:	854e                	mv	a0,s3
ffffffffc0201288:	9482                	jalr	s1
        while (-- width > 0)
ffffffffc020128a:	fc65                	bnez	s0,ffffffffc0201282 <printnum+0x2e>
    }
    // then print this (the least significant) digit
    putch("0123456789abcdef"[mod], putdat);
ffffffffc020128c:	1a02                	slli	s4,s4,0x20
ffffffffc020128e:	00001797          	auipc	a5,0x1
ffffffffc0201292:	afa78793          	addi	a5,a5,-1286 # ffffffffc0201d88 <best_fit_pmm_manager+0x38>
ffffffffc0201296:	020a5a13          	srli	s4,s4,0x20
ffffffffc020129a:	9a3e                	add	s4,s4,a5
}
ffffffffc020129c:	7402                	ld	s0,32(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc020129e:	000a4503          	lbu	a0,0(s4)
}
ffffffffc02012a2:	70a2                	ld	ra,40(sp)
ffffffffc02012a4:	69a2                	ld	s3,8(sp)
ffffffffc02012a6:	6a02                	ld	s4,0(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc02012a8:	85ca                	mv	a1,s2
ffffffffc02012aa:	87a6                	mv	a5,s1
}
ffffffffc02012ac:	6942                	ld	s2,16(sp)
ffffffffc02012ae:	64e2                	ld	s1,24(sp)
ffffffffc02012b0:	6145                	addi	sp,sp,48
    putch("0123456789abcdef"[mod], putdat);
ffffffffc02012b2:	8782                	jr	a5
        printnum(putch, putdat, result, base, width - 1, padc);
ffffffffc02012b4:	03065633          	divu	a2,a2,a6
ffffffffc02012b8:	8722                	mv	a4,s0
ffffffffc02012ba:	f9bff0ef          	jal	ra,ffffffffc0201254 <printnum>
ffffffffc02012be:	b7f9                	j	ffffffffc020128c <printnum+0x38>

ffffffffc02012c0 <vprintfmt>:
 *
 * Call this function if you are already dealing with a va_list.
...
ffffffffc02012c0:	7119                	addi	sp,sp,-128
ffffffffc02012c2:	f4a6                	sd	s1,104(sp)
ffffffffc02012c4:	f0ca                	sd	s2,96(sp)
ffffffffc02012c6:	ecce                	sd	s3,88(sp)
ffffffffc02012c8:	e8d2                	sd	s4,80(sp)
ffffffffc02012ca:	e4d6                	sd	s5,72(sp)
ffffffffc02012cc:	e0da                	sd	s6,64(sp)
ffffffffc02012ce:	fc5e                	sd	s7,56(sp)
ffffffffc02012d0:	f06a                	sd	s10,32(sp)
ffffffffc02012d2:	fc86                	sd	ra,120(sp)
ffffffffc02012d4:	f8a2                	sd	s0,112(sp)
ffffffffc02012d6:	f862                	sd	s8,48(sp)
ffffffffc02012d8:	f466                	sd	s9,40(sp)
ffffffffc02012da:	ec6e                	sd	s11,24(sp)
ffffffffc02012dc:	892a                	mv	s2,a0
ffffffffc02012de:	84ae                	mv	s1,a1
ffffffffc02012e0:	8d32                	mv	s10,a2
ffffffffc02012e2:	8a36                	mv	s4,a3
    register int ch, err;
...
ffffffffc02012e4:	02500993          	li	s3,37
        ...
        char padc = ' ';
        width = precision = -1;
ffffffffc02012e8:	5b7d                	li	s6,-1
ffffffffc02012ea:	00001a97          	auipc	s5,0x1
ffffffffc02012ee:	ad2a8a93          	addi	s5,s5,-1326 # ffffffffc0201dbc <best_fit_pmm_manager+0x6c>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
...
ffffffffc02012f2:	00001b97          	auipc	s7,0x1
ffffffffc02012f6:	ca6b8b93          	addi	s7,s7,-858 # ffffffffc0201f98 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc02012fa:	000d4503          	lbu	a0,0(s10)
ffffffffc02012fe:	001d0413          	addi	s0,s10,1
ffffffffc0201302:	01350a63          	beq	a0,s3,ffffffffc0201316 <vprintfmt+0x56>
            if (ch == '\0') {
ffffffffc0201306:	c121                	beqz	a0,ffffffffc0201346 <vprintfmt+0x86>
            putch(ch, putdat);
ffffffffc0201308:	85a6                	mv	a1,s1
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc020130a:	0405                	addi	s0,s0,1
            putch(ch, putdat);
ffffffffc020130c:	9902                	jalr	s2
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc020130e:	fff44503          	lbu	a0,-1(s0)
ffffffffc0201312:	ff351ae3          	bne	a0,s3,ffffffffc0201306 <vprintfmt+0x46>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0201316:	00044603          	lbu	a2,0(s0)
        char padc = ' ';
ffffffffc020131a:	02000793          	li	a5,32
        lflag = altflag = 0;
ffffffffc020131e:	4c81                	li	s9,0
ffffffffc0201320:	4881                	li	a7,0
        width = precision = -1;
ffffffffc0201322:	5c7d                	li	s8,-1
ffffffffc0201324:	5dfd                	li	s11,-1
ffffffffc0201326:	05500513          	li	a0,85
                if (ch < '0' || ch > '9') {
ffffffffc020132a:	4825                	li	a6,9
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc020132c:	fdd6059b          	addiw	a1,a2,-35
ffffffffc0201330:	0ff5f593          	zext.b	a1,a1
ffffffffc0201334:	00140d13          	addi	s10,s0,1
ffffffffc0201338:	04b56263          	bltu	a0,a1,ffffffffc020137c <vprintfmt+0xbc>
ffffffffc020133c:	058a                	slli	a1,a1,0x2
ffffffffc020133e:	95d6                	add	a1,a1,s5
ffffffffc0201340:	4194                	lw	a3,0(a1)
ffffffffc0201342:	96d6                	add	a3,a3,s5
ffffffffc0201344:	8682                	jr	a3
            for (fmt --; fmt[-1] != '%'; fmt --)
                /* do nothing */;
            break;
        }
...
ffffffffc0201346:	70e6                	ld	ra,120(sp)
ffffffffc0201348:	7446                	ld	s0,112(sp)
ffffffffc020134a:	74a6                	ld	s1,104(sp)
ffffffffc020134c:	7906                	ld	s2,96(sp)
ffffffffc020134e:	69e6                	ld	s3,88(sp)
ffffffffc0201350:	6a46                	ld	s4,80(sp)
ffffffffc0201352:	6aa6                	ld	s5,72(sp)
ffffffffc0201354:	6b06                	ld	s6,64(sp)
ffffffffc0201356:	7be2                	ld	s7,56(sp)
ffffffffc0201358:	7c42                	ld	s8,48(sp)
ffffffffc020135a:	7ca2                	ld	s9,40(sp)
ffffffffc020135c:	7d02                	ld	s10,32(sp)
ffffffffc020135e:	6de2                	ld	s11,24(sp)
ffffffffc0201360:	6109                	addi	sp,sp,128
ffffffffc0201362:	8082                	ret
            padc = '0';
ffffffffc0201364:	87b2                	mv	a5,a2
            goto reswitch;
ffffffffc0201366:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc020136a:	846a                	mv	s0,s10
ffffffffc020136c:	00140d13          	addi	s10,s0,1
ffffffffc0201370:	fdd6059b          	addiw	a1,a2,-35
ffffffffc0201374:	0ff5f593          	zext.b	a1,a1
ffffffffc0201378:	fcb572e3          	bgeu	a0,a1,ffffffffc020133c <vprintfmt+0x7c>
            putch('%', putdat);
ffffffffc020137c:	85a6                	mv	a1,s1
ffffffffc020137e:	02500513          	li	a0,37
ffffffffc0201382:	9902                	jalr	s2
            for (fmt --; fmt[-1] != '%'; fmt --)
ffffffffc0201384:	fff44783          	lbu	a5,-1(s0)
ffffffffc0201388:	8d22                	mv	s10,s0
ffffffffc020138a:	f73788e3          	beq	a5,s3,ffffffffc02012fa <vprintfmt+0x3a>
ffffffffc020138e:	ffed4783          	lbu	a5,-2(s10)
ffffffffc0201392:	1d7d                	addi	s10,s10,-1
ffffffffc0201394:	ff379de3          	bne	a5,s3,ffffffffc020138e <vprintfmt+0xce>
ffffffffc0201398:	b78d                	j	ffffffffc02012fa <vprintfmt+0x3a>
                precision = precision * 10 + ch - '0';
ffffffffc020139a:	fd060c1b          	addiw	s8,a2,-48
                ch = *fmt;
ffffffffc020139e:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc02013a2:	846a                	mv	s0,s10
                if (ch < '0' || ch > '9') {
ffffffffc02013a4:	fd06069b          	addiw	a3,a2,-48
                ch = *fmt;
ffffffffc02013a8:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc02013ac:	02d86463          	bltu	a6,a3,ffffffffc02013d4 <vprintfmt+0x114>
                ch = *fmt;
ffffffffc02013b0:	00144603          	lbu	a2,1(s0)
                precision = precision * 10 + ch - '0';
ffffffffc02013b4:	002c169b          	slliw	a3,s8,0x2
ffffffffc02013b8:	0186873b          	addw	a4,a3,s8
ffffffffc02013bc:	0017171b          	slliw	a4,a4,0x1
ffffffffc02013c0:	9f2d                	addw	a4,a4,a1
                if (ch < '0' || ch > '9') {
ffffffffc02013c2:	fd06069b          	addiw	a3,a2,-48
            for (precision = 0; ; ++ fmt) {
ffffffffc02013c6:	0405                	addi	s0,s0,1
                precision = precision * 10 + ch - '0';
ffffffffc02013c8:	fd070c1b          	addiw	s8,a4,-48
                ch = *fmt;
ffffffffc02013cc:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc02013d0:	fed870e3          	bgeu	a6,a3,ffffffffc02013b0 <vprintfmt+0xf0>
            if (width < 0)
ffffffffc02013d4:	f40ddce3          	bgez	s11,ffffffffc020132c <vprintfmt+0x6c>
                width = precision, precision = -1;
ffffffffc02013d8:	8de2                	mv	s11,s8
ffffffffc02013da:	5c7d                	li	s8,-1
ffffffffc02013dc:	bf81                	j	ffffffffc020132c <vprintfmt+0x6c>
            if (width < 0)
ffffffffc02013de:	fffdc693          	not	a3,s11
ffffffffc02013e2:	96fd                	srai	a3,a3,0x3f
ffffffffc02013e4:	00ddfdb3          	and	s11,s11,a3
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc02013e8:	00144603          	lbu	a2,1(s0)
ffffffffc02013ec:	2d81                	sext.w	s11,s11
ffffffffc02013ee:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc02013f0:	bf35                	j	ffffffffc020132c <vprintfmt+0x6c>
            precision = va_arg(ap, int);
ffffffffc02013f2:	000a2c03          	lw	s8,0(s4)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc02013f6:	00144603          	lbu	a2,1(s0)
            precision = va_arg(ap, int);
ffffffffc02013fa:	0a21                	addi	s4,s4,8
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc02013fc:	846a                	mv	s0,s10
            goto process_precision;
ffffffffc02013fe:	bfd9                	j	ffffffffc02013d4 <vprintfmt+0x114>
    if (lflag >= 2) {
ffffffffc0201400:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0201402:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0201406:	01174463          	blt	a4,a7,ffffffffc020140e <vprintfmt+0x14e>
    else if (lflag) {
ffffffffc020140a:	1a088e63          	beqz	a7,ffffffffc02015c6 <vprintfmt+0x306>
        return va_arg(*ap, unsigned long);
ffffffffc020140e:	000a3603          	ld	a2,0(s4)
ffffffffc0201412:	46c1                	li	a3,16
ffffffffc0201414:	8a2e                	mv	s4,a1
            printnum(putch, putdat, num, base, width, padc);
ffffffffc0201416:	2781                	sext.w	a5,a5
ffffffffc0201418:	876e                	mv	a4,s11
ffffffffc020141a:	85a6                	mv	a1,s1
ffffffffc020141c:	854a                	mv	a0,s2
ffffffffc020141e:	e37ff0ef          	jal	ra,ffffffffc0201254 <printnum>
            break;
ffffffffc0201422:	bde1                	j	ffffffffc02012fa <vprintfmt+0x3a>
            putch(va_arg(ap, int), putdat);
ffffffffc0201424:	000a2503          	lw	a0,0(s4)
ffffffffc0201428:	85a6                	mv	a1,s1
ffffffffc020142a:	0a21                	addi	s4,s4,8
ffffffffc020142c:	9902                	jalr	s2
            break;
ffffffffc020142e:	b5f1                	j	ffffffffc02012fa <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc0201430:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0201432:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0201436:	01174463          	blt	a4,a7,ffffffffc020143e <vprintfmt+0x17e>
    else if (lflag) {
ffffffffc020143a:	18088163          	beqz	a7,ffffffffc02015bc <vprintfmt+0x2fc>
        return va_arg(*ap, unsigned long);
ffffffffc020143e:	000a3603          	ld	a2,0(s4)
ffffffffc0201442:	46a9                	li	a3,10
ffffffffc0201444:	8a2e                	mv	s4,a1
ffffffffc0201446:	bfc1                	j	ffffffffc0201416 <vprintfmt+0x156>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0201448:	00144603          	lbu	a2,1(s0)
            altflag = 1;
ffffffffc020144c:	4c85                	li	s9,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc020144e:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0201450:	bdf1                	j	ffffffffc020132c <vprintfmt+0x6c>
            putch(ch, putdat);
ffffffffc0201452:	85a6                	mv	a1,s1
ffffffffc0201454:	02500513          	li	a0,37
ffffffffc0201458:	9902                	jalr	s2
            break;
ffffffffc020145a:	b545                	j	ffffffffc02012fa <vprintfmt+0x3a>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc020145c:	00144603          	lbu	a2,1(s0)
            lflag ++;
ffffffffc0201460:	2885                	addiw	a7,a7,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0201462:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0201464:	b5e1                	j	ffffffffc020132c <vprintfmt+0x6c>
    if (lflag >= 2) {
ffffffffc0201466:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0201468:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc020146c:	01174463          	blt	a4,a7,ffffffffc0201474 <vprintfmt+0x1b4>
    else if (lflag) {
ffffffffc0201470:	14088163          	beqz	a7,ffffffffc02015b2 <vprintfmt+0x2f2>
        return va_arg(*ap, unsigned long);
ffffffffc0201474:	000a3603          	ld	a2,0(s4)
ffffffffc0201478:	46a1                	li	a3,8
ffffffffc020147a:	8a2e                	mv	s4,a1
ffffffffc020147c:	bf69                	j	ffffffffc0201416 <vprintfmt+0x156>
            putch('0', putdat);
ffffffffc020147e:	03000513          	li	a0,48
...
ffffffffc020148a:	07800513          	li	a0,120
...
ffffffffc0201494:	46c1                	li	a3,16
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc0201496:	ff8a3603          	ld	a2,-8(s4)
            goto number;
ffffffffc020149a:	bfb5                	j	ffffffffc0201416 <vprintfmt+0x156>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc020149c:	000a3403          	ld	s0,0(s4)
ffffffffc02014a0:	008a0713          	addi	a4,s4,8
ffffffffc02014a4:	e03a                	sd	a4,0(sp)
ffffffffc02014a6:	14040263          	beqz	s0,ffffffffc02015ea <vprintfmt+0x32a>
            if (width > 0 && padc != '-') {
ffffffffc02014aa:	0fb05763          	blez	s11,ffffffffc0201598 <vprintfmt+0x2d8>
ffffffffc02014ae:	02d00693          	li	a3,45
ffffffffc02014b2:	0cd79163          	bne	a5,a3,ffffffffc0201574 <vprintfmt+0x2b4>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc02014b6:	00044783          	lbu	a5,0(s0)
ffffffffc02014ba:	0007851b          	sext.w	a0,a5
ffffffffc02014be:	cf85                	beqz	a5,ffffffffc02014f6 <vprintfmt+0x236>
ffffffffc02014c0:	00140a13          	addi	s4,s0,1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc02014c4:	05e00413          	li	s0,94
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc02014c8:	000c4563          	bltz	s8,ffffffffc02014d2 <vprintfmt+0x212>
ffffffffc02014cc:	3c7d                	addiw	s8,s8,-1
ffffffffc02014ce:	036c0263          	beq	s8,s6,ffffffffc02014f2 <vprintfmt+0x232>
                    putch('?', putdat);
ffffffffc02014d2:	85a6                	mv	a1,s1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc02014d4:	0e0c8e63          	beqz	s9,ffffffffc02015d0 <vprintfmt+0x310>
ffffffffc02014d8:	3781                	addiw	a5,a5,-32
ffffffffc02014da:	0ef47b63          	bgeu	s0,a5,ffffffffc02015d0 <vprintfmt+0x310>
                    putch('?', putdat);
ffffffffc02014de:	03f00513          	li	a0,63
ffffffffc02014e2:	9902                	jalr	s2
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc02014e4:	000a4783          	lbu	a5,0(s4)
ffffffffc02014e8:	3dfd                	addiw	s11,s11,-1
ffffffffc02014ea:	0a05                	addi	s4,s4,1
ffffffffc02014ec:	0007851b          	sext.w	a0,a5
ffffffffc02014f0:	ffe1                	bnez	a5,ffffffffc02014c8 <vprintfmt+0x208>
            for (; width > 0; width --) {
ffffffffc02014f2:	01b05963          	blez	s11,ffffffffc0201504 <vprintfmt+0x244>
...
ffffffffc02014fe:	9902                	jalr	s2
            for (; width > 0; width --) {
ffffffffc0201500:	fe0d9be3          	bnez	s11,ffffffffc02014f6 <vprintfmt+0x236>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc0201504:	6a02                	ld	s4,0(sp)
ffffffffc0201506:	bbd5                	j	ffffffffc02012fa <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc0201508:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc020150a:	008a0c93          	addi	s9,s4,8
    if (lflag >= 2) {
ffffffffc020150e:	01174463          	blt	a4,a7,ffffffffc0201516 <vprintfmt+0x256>
    else if (lflag) {
ffffffffc0201512:	08088d63          	beqz	a7,ffffffffc02015ac <vprintfmt+0x2ec>
        return va_arg(*ap, long);
ffffffffc0201516:	000a3403          	ld	s0,0(s4)
            if ((long long)num < 0) {
ffffffffc020151a:	0a044d63          	bltz	s0,ffffffffc02015d4 <vprintfmt+0x314>
            num = getint(&ap, lflag);
ffffffffc020151e:	8622                	mv	a2,s0
ffffffffc0201520:	8a66                	mv	s4,s9
ffffffffc0201522:	46a9                	li	a3,10
ffffffffc0201524:	bdcd                	j	ffffffffc0201416 <vprintfmt+0x156>
            err = va_arg(ap, int);
ffffffffc0201526:	000a2783          	lw	a5,0(s4)
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc020152a:	4719                	li	a4,6
            err = va_arg(ap, int);
ffffffffc020152c:	0a21                	addi	s4,s4,8
            if (err < 0) {
ffffffffc020152e:	41f7d69b          	sraiw	a3,a5,0x1f
ffffffffc0201532:	8fb5                	xor	a5,a5,a3
ffffffffc0201534:	40d786bb          	subw	a3,a5,a3
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0201538:	02d74163          	blt	a4,a3,ffffffffc020155a <vprintfmt+0x29a>
ffffffffc020153c:	00369793          	slli	a5,a3,0x3
ffffffffc0201540:	97de                	add	a5,a5,s7
ffffffffc0201542:	639c                	ld	a5,0(a5)
ffffffffc0201544:	cb99                	beqz	a5,ffffffffc020155a <vprintfmt+0x29a>
                printfmt(putch, putdat, "%s", p);
ffffffffc0201546:	86be                	mv	a3,a5
ffffffffc0201548:	00001617          	auipc	a2,0x1
ffffffffc020154c:	87060613          	addi	a2,a2,-1936 # ffffffffc0201db8 <best_fit_pmm_manager+0x68>
ffffffffc0201550:	85a6                	mv	a1,s1
ffffffffc0201552:	854a                	mv	a0,s2
ffffffffc0201554:	0ce000ef          	jal	ra,ffffffffc0201622 <printfmt>
ffffffffc0201558:	b34d                	j	ffffffffc02012fa <vprintfmt+0x3a>
                printfmt(putch, putdat, "error %d", err);
ffffffffc020155a:	00001617          	auipc	a2,0x1
ffffffffc020155e:	84e60613          	addi	a2,a2,-1970 # ffffffffc0201da8 <best_fit_pmm_manager+0x58>
ffffffffc0201562:	85a6                	mv	a1,s1
ffffffffc0201564:	854a                	mv	a0,s2
ffffffffc0201566:	0bc000ef          	jal	ra,ffffffffc0201622 <printfmt>
ffffffffc020156a:	bb41                	j	ffffffffc02012fa <vprintfmt+0x3a>
                p = "(null)";
ffffffffc020156c:	00001417          	auipc	s0,0x1
ffffffffc0201570:	83440413          	addi	s0,s0,-1996 # ffffffffc0201da0 <best_fit_pmm_manager+0x50>
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0201574:	85e2                	mv	a1,s8
ffffffffc0201576:	8522                	mv	a0,s0
ffffffffc0201578:	e43e                	sd	a5,8(sp)
ffffffffc020157a:	c69ff0ef          	jal	ra,ffffffffc02011e2 <strnlen>
ffffffffc020157e:	40ad8dbb          	subw	s11,s11,a0
ffffffffc0201582:	01b05b63          	blez	s11,ffffffffc0201598 <vprintfmt+0x2d8>
                    putch(padc, putdat);
ffffffffc0201586:	67a2                	ld	a5,8(sp)
ffffffffc0201588:	00078a1b          	sext.w	s4,a5
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc020158c:	3dfd                	addiw	s11,s11,-1
                    putch(padc, putdat);
ffffffffc020158e:	85a6                	mv	a1,s1
ffffffffc0201590:	8552                	mv	a0,s4
ffffffffc0201592:	9902                	jalr	s2
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0201594:	fe0d9ce3          	bnez	s11,ffffffffc020158c <vprintfmt+0x2cc>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0201598:	00044783          	lbu	a5,0(s0)
ffffffffc020159c:	00140a13          	addi	s4,s0,1
ffffffffc02015a0:	0007851b          	sext.w	a0,a5
ffffffffc02015a4:	d3a5                	beqz	a5,ffffffffc0201504 <vprintfmt+0x244>
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc02015a6:	05e00413          	li	s0,94
ffffffffc02015aa:	bf39                	j	ffffffffc02014c8 <vprintfmt+0x208>
        return va_arg(*ap, int);
ffffffffc02015ac:	000a2403          	lw	s0,0(s4)
ffffffffc02015b0:	b7ad                	j	ffffffffc020151a <vprintfmt+0x25a>
        return va_arg(*ap, unsigned int);
ffffffffc02015b2:	000a6603          	lwu	a2,0(s4)
ffffffffc02015b6:	46a1                	li	a3,8
ffffffffc02015b8:	8a2e                	mv	s4,a1
ffffffffc02015ba:	bdb1                	j	ffffffffc0201416 <vprintfmt+0x156>
ffffffffc02015bc:	000a6603          	lwu	a2,0(s4)
ffffffffc02015c0:	46a9                	li	a3,10
ffffffffc02015c2:	8a2e                	mv	s4,a1
ffffffffc02015c4:	bd89                	j	ffffffffc0201416 <vprintfmt+0x156>
ffffffffc02015c6:	000a6603          	lwu	a2,0(s4)
ffffffffc02015ca:	46c1                	li	a3,16
ffffffffc02015cc:	8a2e                	mv	s4,a1
ffffffffc02015ce:	b5a1                	j	ffffffffc0201416 <vprintfmt+0x156>
                    putch(ch, putdat);
ffffffffc02015d0:	9902                	jalr	s2
ffffffffc02015d2:	bf09                	j	ffffffffc02014e4 <vprintfmt+0x224>
                putch('-', putdat);
ffffffffc02015d4:	85a6                	mv	a1,s1
ffffffffc02015d6:	02d00513          	li	a0,45
ffffffffc02015da:	e03e                	sd	a5,0(sp)
ffffffffc02015dc:	9902                	jalr	s2
                num = -(long long)num;
ffffffffc02015de:	6782                	ld	a5,0(sp)
ffffffffc02015e0:	8a66                	mv	s4,s9
ffffffffc02015e2:	40800633          	neg	a2,s0
ffffffffc02015e6:	46a9                	li	a3,10
ffffffffc02015e8:	b53d                	j	ffffffffc0201416 <vprintfmt+0x156>
            if (width > 0 && padc != '-') {
ffffffffc02015ea:	03b05163          	blez	s11,ffffffffc020160c <vprintfmt+0x34c>
ffffffffc02015ee:	02d00693          	li	a3,45
ffffffffc02015f2:	f6d79de3          	bne	a5,a3,ffffffffc020156c <vprintfmt+0x2ac>
                p = "(null)";
ffffffffc02015f6:	00000417          	auipc	s0,0x0
ffffffffc02015fa:	7aa40413          	addi	s0,s0,1962 # ffffffffc0201da0 <best_fit_pmm_manager+0x50>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc02015fe:	02800793          	li	a5,40
ffffffffc0201602:	02800513          	li	a0,40
ffffffffc0201606:	00140a13          	addi	s4,s0,1
ffffffffc020160a:	bd6d                	j	ffffffffc02014c4 <vprintfmt+0x204>
ffffffffc020160c:	00000a17          	auipc	s4,0x0
ffffffffc0201610:	795a0a13          	addi	s4,s4,1941 # ffffffffc0201da1 <best_fit_pmm_manager+0x51>
ffffffffc0201614:	02800513          	li	a0,40
ffffffffc0201618:	02800793          	li	a5,40
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc020161c:	05e00413          	li	s0,94
ffffffffc0201620:	b565                	j	ffffffffc02014c8 <vprintfmt+0x208>

ffffffffc0201622 <printfmt>:
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0201622:	715d                	addi	sp,sp,-80
    va_start(ap, fmt);
ffffffffc0201624:	02810313          	addi	t1,sp,40
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0201628:	f436                	sd	a3,40(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc020162a:	869a                	mv	a3,t1
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc020162c:	ec06                	sd	ra,24(sp)
ffffffffc020162e:	f83a                	sd	a4,48(sp)
ffffffffc0201630:	fc3e                	sd	a5,56(sp)
ffffffffc0201632:	e0c2                	sd	a6,64(sp)
ffffffffc0201634:	e4c6                	sd	a7,72(sp)
    va_start(ap, fmt);
ffffffffc0201636:	e41a                	sd	t1,8(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc0201638:	c89ff0ef          	jal	ra,ffffffffc02012c0 <vprintfmt>
}
ffffffffc020163c:	60e2                	ld	ra,24(sp)
ffffffffc020163e:	6161                	addi	sp,sp,80
ffffffffc0201640:	8082                	ret

ffffffffc0201642 <sbi_console_putchar>:
...
uint64_t sbi_call(uint64_t sbi_type, uint64_t arg0, uint64_t arg1, uint64_t arg2) {
    uint64_t ret_val;
    __asm__ volatile (
ffffffffc0201642:	4781                	li	a5,0
ffffffffc0201644:	00004717          	auipc	a4,0x4
ffffffffc0201648:	9cc73703          	ld	a4,-1588(a4) # ffffffffc0205010 <SBI_CONSOLE_PUTCHAR>
ffffffffc020164c:	88ba                	mv	a7,a4
ffffffffc020164e:	852a                	mv	a0,a0
ffffffffc0201650:	85be                	mv	a1,a5
ffffffffc0201652:	863e                	mv	a2,a5
ffffffffc0201654:	00000073          	ecall
