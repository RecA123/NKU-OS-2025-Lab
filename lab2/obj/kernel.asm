...
ffffffffc020021c:	52d0106f          	j	ffffffffc0201f48 <sbi_console_putchar>
...
ffffffffc0200226:	ede50513          	addi	a0,a0,-290 # ffffffffc0202100 <etext+0x112>
void dtb_init(void) {
...
ffffffffc0200254:	ec050513          	addi	a0,a0,-320 # ffffffffc0202110 <etext+0x122>
...
ffffffffc020026a:	eba50513          	addi	a0,a0,-326 # ffffffffc0202120 <etext+0x132>
...
ffffffffc020027a:	ec250513          	addi	a0,a0,-318 # ffffffffc0202138 <etext+0x14a>
    if (boot_dtb == 0) {
...
ffffffffc02002bc:	2581                	sext.w	a1,a1
    if (magic != 0xd00dfeed) {
ffffffffc02002be:	eed78793          	addi	a5,a5,-275 # ffffffffd00dfeed <end+0xfed9425>
...
ffffffffc0200334:	e5890913          	addi	s2,s2,-424 # ffffffffc0202188 <etext+0x19a>
...
ffffffffc0200342:	e4248493          	addi	s1,s1,-446 # ffffffffc0202180 <etext+0x192>
...
ffffffffc0200396:	e6e50513          	addi	a0,a0,-402 # ffffffffc0202200 <etext+0x212>
ffffffffc020039a:	db3ff0ef          	jal	ra,ffffffffc020014c <cprintf>
    }
    cprintf("DTB init completed\n");
ffffffffc020039e:	00002517          	auipc	a0,0x2
ffffffffc02003a2:	e9a50513          	addi	a0,a0,-358 # ffffffffc0202238 <etext+0x24a>
}
...
ffffffffc02003e2:	d7a50513          	addi	a0,a0,-646 # ffffffffc0202158 <etext+0x16a>
}
...
ffffffffc02003ec:	377010ef          	jal	ra,ffffffffc0201f62 <strlen>
...
ffffffffc02003f8:	2a01                	sext.w	s4,s4
                if (strncmp(name, "memory", 6) == 0) {
ffffffffc02003fa:	3bd010ef          	jal	ra,ffffffffc0201fb6 <strncmp>
...
ffffffffc0200490:	309010ef          	jal	ra,ffffffffc0201f98 <strcmp>
...
ffffffffc02004a8:	cec50513          	addi	a0,a0,-788 # ffffffffc0202190 <etext+0x1a2>
           fdt32_to_cpu(x >> 32);
...
ffffffffc0200576:	c3e50513          	addi	a0,a0,-962 # ffffffffc02021b0 <etext+0x1c2>
...
ffffffffc0200588:	c4450513          	addi	a0,a0,-956 # ffffffffc02021c8 <etext+0x1da>
...
ffffffffc020059a:	c5250513          	addi	a0,a0,-942 # ffffffffc02021e8 <etext+0x1fa>
ffffffffc020059e:	bafff0ef          	jal	ra,ffffffffc020014c <cprintf>
    cprintf("DTB init completed\n");
ffffffffc02005a2:	00002517          	auipc	a0,0x2
ffffffffc02005a6:	c9650513          	addi	a0,a0,-874 # ffffffffc0202238 <etext+0x24a>
        memory_base = mem_base;
ffffffffc02005aa:	00006797          	auipc	a5,0x6
ffffffffc02005ae:	4c87bf23          	sd	s0,1246(a5) # ffffffffc0206a88 <memory_base>
        memory_size = mem_size;
ffffffffc02005b2:	00006797          	auipc	a5,0x6
ffffffffc02005b6:	4d67bf23          	sd	s6,1246(a5) # ffffffffc0206a90 <memory_size>
    cprintf("DTB init completed\n");
...
ffffffffc02005c0:	4cc53503          	ld	a0,1228(a0) # ffffffffc0206a88 <memory_base>
...
ffffffffc02005ca:	4ca53503          	ld	a0,1226(a0) # ffffffffc0206a90 <memory_size>
